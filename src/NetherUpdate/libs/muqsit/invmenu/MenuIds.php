...
namespace NetherUpdate\libs\muqsit\invmenu;

use NetherUpdate\libs\muqsit\invmenu\inventories\ChestInventory;
use NetherUpdate\libs\muqsit\invmenu\inventories\DoubleChestInventory;
use NetherUpdate\libs\muqsit\invmenu\inventories\HopperInventory;
